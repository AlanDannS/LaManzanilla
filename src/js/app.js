const seccionesPaginas = new fullpage('#fullpage',{
	...
	// ──────────────────────────────────────────────────
		 ...
		 anchors: ['inicio', 'sobre', 'productos', 'contacto'], // Anclas, las usamos para identificar cada seccion y poder acceder a ellas con el menu.
		 navigationTooltips: ['Inicio', 'Sobre', 'Productos', 'Contacto'], // Tooltips que mostrara por cada boton.
